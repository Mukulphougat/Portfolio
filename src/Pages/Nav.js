        ...
        <AnimatePresence>
            <div className="flex-col dark:bg-gray-900 fixed bg-white top-0 h-full w-10 align-middle justify-between">
                ...
                <div className={"flex-col mx-1 fixed bottom-5 justify-center align-middle my-1"}>
                    ...
                    <motion.div initial={{ y: -500}} animate={{ y:0 }} exit={{ y: -500 }} whileTap={{ scale: 0.8 }} className="my-8"><a href={"https://drive.google.com/file/d/1X7vsL3gbr0-VLRFHY3T-bmFOXl5YcGYe/view?usp=sharing"} target={"_blank"} rel={"noreferrer"} ><img src={resume} className={"w-8 h-8"} alt={"resume"}/></a></motion.div>
