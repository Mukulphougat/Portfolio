    ...
    return (
        <motion.div initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}}
            ...
            <div className={"flex-col my-8 dark:shadow-gray-700 rounded-xl mx-20 shadow-sm shadow-cyan-200 items-center justify-center"}>
                <h1 className={"font-mono dark:text-white font-bold p-4 underline text-3xl w-full "}>Skills</h1>
                <div className={"mx-4 flex-col align-middle justify-center "}>
                    <motion.h1 initial={{x: -550, overflow: "hidden"}} animate={{x: 0}} transition={{delay: .8}}
                               className={"font-mono dark:text-green-500 font-thin p-1.5 w-fit text-2xl text-blue-500"}>Java
                    </motion.h1>
                    <motion.h1 initial={{x: -550, overflow: "hidden"}} animate={{x: 0}} transition={{delay: .8}}
                               className={"font-mono dark:text-green-500 font-thin p-1.5 w-fit text-2xl text-blue-500"}>Javascript
                    </motion.h1>
                    <motion.h1 initial={{x: -550, overflow: "hidden"}} animate={{x: 0}} transition={{delay: .8}}
                               className={"font-mono dark:text-green-500 font-thin p-1.5 w-fit text-2xl text-blue-500"}>MongoDb
                    </motion.h1>
                    <motion.h1 initial={{x: -550, overflow: "hidden"}} animate={{x: 0}} transition={{delay: .8}}
                               className={"font-mono dark:text-green-500 font-thin p-1.5 w-fit text-2xl text-blue-500"}>MySQL
                    </motion.h1>
                    <motion.h1 initial={{x: -550, overflow: "hidden"}} animate={{x: 0}} transition={{delay: .8}}
                               className={"font-mono dark:text-green-500 font-thin p-1.5 w-fit text-2xl text-blue-500"}>React
                    </motion.h1>
                    <motion.h1 initial={{x: -550, overflow: "hidden"}} animate={{x: 0}} transition={{delay: .8}}
                               className={"font-mono dark:text-green-500 font-thin p-1.5 w-fit text-2xl text-blue-500"}>Spring
                    </motion.h1>
                    <motion.h1 initial={{x: -550, overflow: "hidden"}} animate={{x: 0}} transition={{delay: .8}}
                               className={"font-mono dark:text-green-500 font-thin p-1.5 w-fit text-2xl text-blue-500"}>Express
                    </motion.h1>
                </div>
            </div>
        </motion.div>
