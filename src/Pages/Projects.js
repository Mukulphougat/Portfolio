                ...
                <motion.div initial={{x: -750, overflow: "hidden"}} animate={{x: 0}} transition={{delay: .8}} className={"flex-col align-middle p-4 w-full"}>
                    <div className={"flex-col w-full"}>
                        ...
                        <div className={"flex my-4 w-full"}>
                            <img src={app1} className={"w-4/12 h-50"} alt={"Music APP"} />
                            <motion.div initial={{x: -1950, overflow: "hidden"}} animate={{x: 0}} transition={{delay: .8}} className={"text-xl mx-20 dark:text-green-400 font-mono"}>
