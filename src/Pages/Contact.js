    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ type: "just", stiffness: 100, delay: 0.5}} className={"text-3xl mx-20 flex flex-col h-screen"}>
            <div className={"md:grid md:grid-cols-2 w-full place-items-center"}>
                <div className={"flex self-center md:w-2/3 w-full my-10 flex-row dark:shadow-gray-500 justify-between dark:text-green-500 font-mono h-24 my-2 w-fit rounded-xl shadow-sm shadow-cyan-200 items-center justify-center"}>
                ...
                <div className={"flex self-center md:w-2/3 w-full my-10 flex-row dark:shadow-gray-500 dark:text-green-500 font-mono h-24 my-2 w-fit rounded-xl shadow-sm shadow-cyan-200 items-center justify-center"}>
